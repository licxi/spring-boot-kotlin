...
(function (undefined) {
    ...
    // [year, month, day , hour, minute, cluster, millisecond]
    ...
    extend(moment.fn = Moment.prototype, {
        ...
        // a cluster time. In case it wants us to change the offset again
...
// Author : Menelion Elens煤le : https://github.com/Oire
    ...
    (function (factory) {
        ...
        function monthsShortCaseReplace(m, format) {
            var monthsShort = {
                    'nominative': '褟薪胁_褎械胁_屑邪褉_邪锌褉_屑邪泄_懈褞薪褜_懈褞谢褜_邪胁谐_褋械薪_芯泻褌_薪芯褟_写械泻'.split('_'),
        ...
        function weekdaysCaseReplace(m, format) {
            var weekdays = {
                ...
                nounCase = (/\[ ?[袙胁] ?(?:锌褉芯褕谢褍褞|褋谢械写褍褞褖褍褞)? ?\] ?dddd/).test(format) ?
                    'accusative' :
                    'nominative';
